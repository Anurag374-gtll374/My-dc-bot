  ...
  run: async (client, message, args) => {
    ...
    if (!args[0]) {
      const embed = new MessageEmbed()
        ...
        .addField(
          "• Developer",
          `\`\`\`yml\nName: Omm᭄FO#7920 [522728463413542925]\nName Ξ Anurag Gill [522728463413542925]\`\`\``
        )
        .addField(
          "• Important Links",
          `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.gg/paHAWeQ)\`|\`[Youtube](https://www.youtube.com/channel/UCiHdd2-l1aND-HdDRVSn7Og/)\`**`
        )
        .setTimestamp();
      ...
      let btn2 = new MessageButton()
        ...
        .setURL(`https://www.youtube.com/channel/UCiHdd2-l1aND-HdDRVSn7Og`);

      let bt3 = new MessageButton()
        .setStyle("url")
        .setLabel(`Join Now`)
        .setURL(`https://discord.gg/paHAWeQ`);
